...
export const settingsTable = pgTable("settings", {
  ...
  robinhoodBearerToken: text("robinhood_bearer_token"),
  webullAppKey: text("webull_app_key"),
  webullAppSecret: text("webull_app_secret"),
  webullAccountId: text("webull_account_id"),
